...
- [ ] **Phase 14: Shared State Foundation** — Migrate consumer cursors and backfill progress to shared Postgres store; establish cluster membership table with heartbeat-based node liveness
...
| 14. Shared State Foundation | 2/3 | In Progress|  | - |
